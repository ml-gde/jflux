...
class TestAttentionMechanism(unittest.TestCase):
    ...
    def test_rope(self):
        ...
        self.assertEqual(rope_output.shape, expected_shape, "rope function output shape is incorrect")
    ...
    def test_apply_rope(self):
        ...
        self.assertEqual(xq_out.shape, self.q.shape, "apply_rope xq output shape is incorrect")
        self.assertEqual(xk_out.shape, self.k.shape, "apply_rope xk output shape is incorrect")
    ...
    def test_attention(self):
        ...
        self.assertEqual(attention_output.shape, expected_shape, "attention function output shape is incorrect")
